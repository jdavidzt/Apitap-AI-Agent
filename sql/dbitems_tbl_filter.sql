...
CREATE TABLE `tbl_filter` (
  `tbl_filter_id` int(11) NOT NULL AUTO_INCREMENT,
  `tbl_filter_name` varchar(99) NOT NULL,
  `tbl_filter_active_f` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`tbl_filter_id`)
...
INSERT INTO `tbl_filter` VALUES (1,'Item',1),(2,'Category',1),(3,'Merchant',1);
...
-- Dump completed on 2026-01-09 14:32:24
