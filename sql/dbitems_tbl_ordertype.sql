...
CREATE TABLE `tbl_ordertype` (
  `tbl_ordertype_id` int(11) NOT NULL AUTO_INCREMENT,
  `tbl_ordertype_name` varchar(45) NOT NULL,
  `tbl_ordertype_bundle` varchar(45) NOT NULL,
  PRIMARY KEY (`tbl_ordertype_id`)
) ENGINE=InnoDB AUTO_INCREMENT=94004 DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_ordertype` VALUES (94001,'Dine-in','4076'),(94002,'Delivery','4077'),(94003,'Pickup','3874');
...
-- Dump completed on 2026-01-09 14:32:58
