...
CREATE TABLE `tbl_userstatus` (
  `tbl_userstatus_id` int(11) NOT NULL,
  `tbl_userstatus_name` varchar(45) DEFAULT NULL,
  `tbl_userstatus_bundle` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`tbl_userstatus_id`)
...
INSERT INTO `tbl_userstatus` VALUES (33,'Active','1184'),(34,'Inactive','1185'),(35,'Pending','925'),(37,'Temporary Password','1465'),(38,'Deleted','3739'),(39,'Forgot Password','667');
