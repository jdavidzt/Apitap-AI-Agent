...
CREATE TABLE `tbl_orderstatus` (
  `tbl_orderstatus_id` int(11) NOT NULL AUTO_INCREMENT,
  `tbl_orderstatus_name` varchar(45) NOT NULL,
  `tbl_orderstatus_bundle` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`tbl_orderstatus_id`)
) ENGINE=InnoDB AUTO_INCREMENT=92005 DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_orderstatus` VALUES (92001,'Open',NULL),(92002,'Done','3360'),(92003,'Close','1544'),(92004,'Cancel',NULL);
