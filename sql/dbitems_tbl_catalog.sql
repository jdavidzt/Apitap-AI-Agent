...
CREATE TABLE `tbl_catalog` (
  ...
  `tbl_catalog_name` varchar(50) NOT NULL,
  `tbl_catalog_addedDate` datetime NOT NULL,
  `tbl_catalog_updatedDate` datetime NOT NULL,
  `tbl_catalog_nmcId` int(11) NOT NULL,
  `tbl_catalog_qrCode` text,
  `tbl_catalog_image` text,
  PRIMARY KEY (`tbl_catalog_id`)
