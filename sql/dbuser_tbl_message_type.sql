...
CREATE TABLE `tbl_message_type` (
  `tbl_message_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `tbl_message_type_name` varchar(45) NOT NULL,
  PRIMARY KEY (`tbl_message_type_id`)
...
INSERT INTO `tbl_message_type` VALUES (1,'General Inquiries'),(2,'Item Messages'),(3,'Ad Campaigns Messages'),(4,'Invoice Messages'),(5,'Return Items Messages');
...
-- Dump completed on 2026-01-09 14:35:21
