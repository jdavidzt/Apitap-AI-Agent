...
CREATE TABLE `tbl_platform` (
  `tbl_platform_id` int(11) NOT NULL AUTO_INCREMENT,
  `tbl_platform_name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`tbl_platform_id`)
...
INSERT INTO `tbl_platform` VALUES (1,'Web'),(2,'Mobile');
